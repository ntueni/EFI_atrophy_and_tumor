...
#ifndef SRC_EFI_INCLUDE_EFI_LAB_ROTATIONAL_RHEOMETER_H_
#define SRC_EFI_INCLUDE_EFI_LAB_ROTATIONAL_RHEOMETER_H_
...
/// @author Stefan Kaessmair
template <int dim>
class RotationalRheometer : public TestingDevice <dim>
{
public:
    ...
    /// Constructor
    RotationalRheometer (const std::string &subsection_name,
...
{
    efilog(Verbosity::verbose) << "New RotationalRheometer created ("
                              << subsection_name
                              << ")." << std::endl;
}
...
#endif /* SRC_EFI_INCLUDE_EFI_LAB_ROTATIONAL_RHEOMETER_H_ */
