...
#ifndef SRC_EFI_INCLUDE_EFI_CONSTITUTIVE_MODIFIED_ONE_TERM_OGDEN_ATROPHY_H_
#define SRC_EFI_INCLUDE_EFI_CONSTITUTIVE_MODIFIED_ONE_TERM_OGDEN_ATROPHY_H_
...
/// @author Stefan Kaessmair
template <int dim>
class ModifiedOneTermOgdenAtrophy : public ConstitutiveBase<dim>
{
public:
    ...
    /// of the to-be-constructed ModifiedOneTermOgdenAtrophy constitutive model and
    /// its end.
    ModifiedOneTermOgdenAtrophy (const std::string &subsection_name,
           const std::string &unprocessed_input);

    /// Default destructor.
    ~ModifiedOneTermOgdenAtrophy () = default;
    ...
    /// the constitutive response of the @p ModifiedOneTermOgdenAtrophy material.
    void
...
#endif /* SRC_EFI_INCLUDE_EFI_CONSTITUTIVE_MODIFIED_ONE_TERM_OGDEN_ATROPHY_H_ */
